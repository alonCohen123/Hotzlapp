      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto" style="float:right;">
          <ol style="margin-top:13px;margin-right: 5px;">
            ...
            <a style="color:#DCDCDC;" class="breadcrumb-item" aria-current="page" href="#"><strong>התנגדות לסכום החוב</strong></a>
          </ol>
    ...
    <div class="container">
      ...
      <div class="tab-wrap">
          <div class="container" style="text-align: center;" >
            ...
            <h1 style="text-align: center;">התנגדות לסכום החוב</h1>
          </div>
        </div>
        ...
        <div class="tab-wrap" >
            ...
            <div class="container" align="center" style="width:100%;">
             <form method="POST" id="comment_form">
              ...
              <div class="form-group">
               ...
               <input type="hidden" name="page" id="page" value="4bc" />
          ...
          <div class="tab__content" style="height: 100%;">
            <p class="lead" align="center" style="font-size: 2.4em;color:#5E86F2;">התנגדות לסכום החוב</p><br>
            <p class="lead" dir="rtl" align="right">בקשה להתנגדות לביצוע תובענה - שירות זה מאפשר לחייב, תוך 30 יום ממועד מסירת האזהרה במסירה מלאה, להשיג על הגשתו לביצוע של שטר חוב או שיק לביצוע מהסיבות שיפורטו בבקשתו. </p><br>

            <button class="accordion">?אילו מסמכים נדרשים להגשת הבקשה</button>
            <div class="panel2">
              <p class="lead" dir="rtl" align="right">תצהיר לאימות העובדות התומכות בהתנגדות והסיבות לאיחור בהגשה.</p>
              <p class="lead" dir="rtl" align="right">מסמכים התומכים בהתנגדות.</p>
              <p class="lead" dir="rtl" align="right">צילום תעודת זהות של החייבים.</p>
              <p class="lead" dir="rtl" align="right">מסמכי הבקשה לפתיחת התיק בהוצאה לפועל</p>
              <p class="lead" dir="rtl" align="right">חתימת גורם מוסמך על התצהיר – את החתימה ניתן לבצע בלשכות הוצאה לפעול בעלות של 48 שקלים.</p>
              <p class="lead" dir="rtl" align="right">חייב המיוצג על ידי עורך דין נדרש להעביר עותק מבקשתו לזוכה.</p><br>
      </div>
              <button class="accordion">?איך ממלאים את הטופס</button>
              <div class="panel2">
                <p class="lead" dir="rtl" align="right">יש להדפיס את הטופס הבקשה להתנגדות ולסמן ב-X את בקשה מספר 106.</p>
                <p class="lead" dir="rtl" align="right">להארכת מועד התנגדות לביצוע תובענה יש לסמן ב-X את בקשה מספר 136.</p>
          ...
          <div class="tab__content" align="center">
            ...
            <p class="lead"><a class="read" target="_blank" href="https://www.gov.il/BlobFolder/service/claim_objection/he/%D7%98%D7%95%D7%A4%D7%A1%20218%20-%20%D7%91%D7%A7%D7%A9%D7%AA%20%D7%97%D7%99%D7%99%D7%91%20-%20%D7%94%D7%AA%D7%A0%D7%92%D7%93%D7%95%D7%AA.pdf">בקשה להתנגדות לביצוע תובענה</a></p>
