          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto" style="float:right;">
              <ol style="margin-top:15px;margin-left: -40px;">
                ...
                <a style="color:#DCDCDC;" class="breadcrumb-item" aria-current="page" href="#"><strong>קבלת החוב</strong></a>
              </ol>
  ...
  <div class="row" dir="rtl">
    <div class="col-md">
      ...
      <div id="content-mobile" class="card">
        <a href="4thstageAA.php">
        <img class="card-img-top" src="../images/timeline/2.jpg"alt=""></a>
        <!-- <div class="card-body" dir="rtl">
          <h4 class="card-title" dir="rtl"></h4>
        </div> -->
        <div class="card-footer" style="text-align:center;">
          <a href="4thstageAA.php" class="btn btn-primary">ביכולתי לשלם את החוב</a>
        </div>
      </div>
      <br>
      <div id="content-mobile" class="card">
        <a href="4thstageAB.php">
        <img class="card-img-top" src="../images/timeline/1.jpg"></a>
        <!-- <div class="card-body" dir="rtl">
          <h4 class="card-title" dir="rtl"></h4>
        </div> -->
        <div class="card-footer" style="text-align:center;">
          <a href="4thstageAB.php" class="btn btn-primary">אין ביכולתי לשלם את החוב</a>
        </div>
      </div>


        <!-- <div style="text-align: center;">
          <img  src="../images/timeline/2.jpg" alt="" height="250" width="375">
          <h4 style="font-size: 1.5em;">ביכולתי לשלם את החוב</h4>
          <a style="font-size: 1.5em;" href="4thstageAA.php" class="btn btn-primary">מידע נוסף</a>

        <br><br>
          <img src="../images/timeline/1.jpg" height="250" width="375" alt="">
          <h4 style="font-size: 1.5em;">אין ביכולתי לשלם את החוב </h4>
          <a style="font-size: 1.5em;" href="4thstageAB.php" class="btn btn-primary">מידע נוסף</a>
        </div> -->
        <br>
    </div>
    <div class="col-md">
