      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto" style="float:right;">
          <ol style="margin-top:13px;margin-right: 5px;">
            ...
            <a style="color:#DCDCDC;" class="breadcrumb-item" aria-current="page" href="#"><strong>פרעתי את החוב</strong></a>
          </ol>
    ...
    <div class="container">
      ...
      <div class="tab-wrap">
          <div class="container" style="text-align: center;" >
            ...
            <h1 style="text-align: center;">פרעתי את החוב</h1>
          </div>
        </div>
        ...
        <div class="tab-wrap" >
            ...
            <div class="container" align="center" style="width:100%;">
             <form method="POST" id="comment_form">
              ...
              <div class="form-group">
               ...
               <input type="hidden" name="page" id="page" value="4bb" />
          ...
          <div class="tab__content" style="height: 100%;">
          <br>
              <p class="lead" align="center" style="font-size: 2.4em;color:#5E86F2;">פרעתי את החוב</p><br>
              <p class="lead" dir="rtl" align="right">בקשה לטענת "פרעתי": בקשה לסגירת תיק או הקטנת חוב מהסיבה כי החוב נפרע. שירות זה מאפשר לחייב בהוצאה לפועל להגיש בקשה שבה יטען כי פרע את חובו, כולו או מקצתו.</p>
              <p class="lead" dir="rtl" align="right">1.	בפס"ד: בעילה שנוצרה לאחר מתן פסק הדין.</p>
              <p class="lead" dir="rtl" align="right">2.	במשכון ומשכנתא: בעילה שנוצרה לאחר הרישום.</p>
              <p class="lead" dir="rtl" align="right">3.	בשטר/ תביעה לסכום קצוב: בעילה שנוצרה לאחר המצאת האזהרה לחייב.</p><br>
<br>
<button class="accordion">?אילו מסמכים נדרשים להגשת הבקשה</button>
<div class="panel2">
  <p class="lead" dir="rtl" align="right">•	טופס 236 - יש לסמן ב-X את קוד בקשה 119.</p>
  <p class="lead" dir="rtl" align="right">•	בקשה מנומקת בכתב.</p>
  <p class="lead" dir="rtl" align="right">•	תצהיר חתום על ידי גורם מוסמך - - ניתן לבצע חתימה זו בלשכות הוצאה לפעול בעלות של 48 ₪.</p>
  <p class="lead" dir="rtl" align="right">•	מסמכים התומכים בבקשת החייב, אם קיימים.</p>
  <p class="lead" dir="rtl" align="right">•	אם מדובר על בקשת חייב ראשונה בתיק, יש להגישה בצירוף צילום של תעודת הזהות</p>
  <p class="lead" dir="rtl" align="right">•	חייב המיוצג על ידי עורך דין נדרש להעביר עותק מבקשתו לזוכה.</p><br>
</div>
<button class="accordion">המשך טיפול הבקשה</button>
<div class="panel2">
<p class="lead" dir="rtl" align="right">לאחר הגשת הבקשה היא תעבור להחלטת רשם ההוצאה לפועל. ההחלטה בתיק תתקבל תוך 45 יום לאחר הקלדת הבקשה. ההחלטה תשלח למגיש בדואר מיד לאחר קבלת ההחלטה.</p>
  <p cla<br>
</div>
    ...
    if (panel.style.maxHeight) {
      ...
      panel.style.maxHeight = panel.scrollHeight + "px";
          ...
          <div class="tab__content" align="center">
            ...
            <p class="lead"><p class="lead"><a target="_blank" href="https://www.gov.il/BlobFolder/generalpage/forms-eca-new-format-1/he/Forms_form236.pdf">טופס 236</a></p></p>
