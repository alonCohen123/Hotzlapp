        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto" style="float:right;">
            <ol style="margin-top:13px;margin-right: 5px;">
              ...
              <a style="color:#DCDCDC;" class="breadcrumb-item" aria-current="page" href="#"><strong>התנגדות לביצוע שטר</strong></a>
            </ol>
    ...
    <div class="container">
        ...
        <div class="tab-wrap">
            <div class="container" style="text-align: center;" >
              ...
              <h1 style="text-align: center;">התנגדות לביצוע שטר</h1>
            </div>
          </div>
        ...
        <div class="tab-wrap" >
            ...
            <div class="container" align="center" style="width:100%;">
             <form method="POST" id="comment_form">
              ...
              <div class="form-group">
               ...
               <input type="hidden" name="page" id="page" value="4ba" />
          ...
          <div class="tab__content" style="height: 100%;"><br>
            <p class="lead" align="center" style="font-size: 2.4em;color:#5E86F2;">התנגדות לביצוע שטר</p><br>
            <p class="lead" dir="rtl" align="right">אם נגד החייב נפתח תיק בגין המחאה או שטר שעליו הוא חתום (כולל שטר משכנתא), והוגשה נגדו בקשה לביצוע שטר או המחאה (צ'ק) או בקשה למימוש משכנתא על דירת מגורים או בקשה למימוש משכנתא אחרת, הוא רשאי להגיש התנגדות לביצוע שטר, אם הוא סבור שלא היתה עילה להגיש את השטר או הצ'ק להוצאה לפועל.</p>
            <p class="lead" dir="rtl" align="right">בקשה להתנגדות לביצוע שטר - שירות זה מאפשר לחייב, תוך 30 יום ממועד מסירת האזהרה במסירה מלאה, להשיג על הגשתו לביצוע של שטר חוב או שיק לביצוע מהסיבות שיפורטו בבקשתו. </p><br>

            <button class="accordion">?אילו מסמכים נדרשים</button>
            <div class="panel2">
          ...
          <div class="tab__content" align="center">
            ...
            <p class="lead"><p class="lead"><a target="_blank" href="https://www.gov.il/he/service/opening_alimony_file">טופס 218</a></p></p>
          </div>
